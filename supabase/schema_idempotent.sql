-- ================================================================
-- GrowthHQ Database Schema (idempotent — safe to re-run)
-- ================================================================
...
DROP POLICY IF EXISTS "Users can manage own growth profile" ON public.growth_profiles;
...
DROP POLICY IF EXISTS "Users can manage own conversations" ON public.coach_conversations;
DROP POLICY IF EXISTS "Users can read coach messages" ON public.coach_messages;
DROP POLICY IF EXISTS "Users can insert coach messages" ON public.coach_messages;
DROP POLICY IF EXISTS "Users can manage own progress" ON public.user_progress;
DROP POLICY IF EXISTS "Users can view own achievements" ON public.user_achievements;
DROP POLICY IF EXISTS "Community posts are public to authenticated users" ON public.community_posts;
...
CREATE POLICY "Users can manage own growth profile" ON public.growth_profiles FOR ALL TO authenticated USING ((select auth.uid()) = user_id);
CREATE POLICY "Users can manage own assessments" ON public.assessments FOR ALL TO authenticated USING ((select auth.uid()) = user_id);
CREATE POLICY "Users can manage own journal" ON public.journal_entries FOR ALL TO authenticated USING ((select auth.uid()) = user_id);
CREATE POLICY "Users can manage own habits" ON public.habits FOR ALL TO authenticated USING ((select auth.uid()) = user_id);
CREATE POLICY "Users can manage own habit logs" ON public.habit_logs FOR ALL TO authenticated USING ((select auth.uid()) = user_id);
CREATE POLICY "Users can manage own conversations" ON public.coach_conversations FOR ALL TO authenticated USING ((select auth.uid()) = user_id);
CREATE POLICY "Users can read coach messages" ON public.coach_messages FOR SELECT TO authenticated USING (
  EXISTS (SELECT 1 FROM public.coach_conversations WHERE id = conversation_id AND user_id = (select auth.uid()))
);
CREATE POLICY "Users can insert coach messages" ON public.coach_messages FOR INSERT TO authenticated WITH CHECK (
  EXISTS (SELECT 1 FROM public.coach_conversations WHERE id = conversation_id AND user_id = (select auth.uid()))
);
CREATE POLICY "Users can manage own progress" ON public.user_progress FOR ALL TO authenticated USING ((select auth.uid()) = user_id);
...
CREATE POLICY "Community posts are public to authenticated users" ON public.community_posts FOR SELECT TO authenticated USING (TRUE);
CREATE POLICY "Users can create community posts" ON public.community_posts FOR INSERT TO authenticated WITH CHECK ((select auth.uid()) = user_id);
CREATE POLICY "Community replies are public" ON public.community_replies FOR SELECT TO authenticated USING (TRUE);
CREATE POLICY "Users can create replies" ON public.community_replies FOR INSERT TO authenticated WITH CHECK ((select auth.uid()) = user_id);
...
CREATE POLICY "Users can update own notifications" ON public.notifications FOR UPDATE TO authenticated USING ((select auth.uid()) = user_id);
