          ...
          {faqs.map((faq, i) => (
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-between px-5 py-4 text-left hover:bg-[#EFF6FF]/50 dark:hover:bg-[#1E3A8A]/30 transition-colors"
              >
                ...
                <ChevronDown
                  className={cn(
                    "w-4 h-4 shrink-0 text-[#2563EB] transition-transform duration-200",
                    open === i && "rotate-180"
                  )}
                />
              </button>
