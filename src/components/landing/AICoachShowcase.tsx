              ...
              {[
                ...
                <li key={item} className="flex items-center gap-3 text-[#4D4D4D] dark:text-[#d1cfc9]">
                  <span className="w-5 h-5 rounded-full bg-[#eef3ff] dark:bg-[#0e1730] flex items-center justify-center shrink-0">
                    <span className="w-2 h-2 rounded-full bg-[#3B6FF6]" />
                  </span>
          ...
          <div className="relative">
            <div className="bg-white dark:bg-[#1a1916] rounded-2xl border border-[#e8e8e4] dark:border-[#2a2824] shadow-[0_20px_60px_rgba(196,98,45,0.12)] overflow-hidden">
              ...
              <div className="px-5 py-4 border-b border-[#f5f4f0] dark:border-[#2a2824] flex items-center gap-3 bg-[#fdfcfa] dark:bg-[#201f1c]">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#3B6FF6] to-[#6E97FF] flex items-center justify-center pulse-ring shadow-md shadow-blue-500/20">
              ...
              <div className="p-5 min-h-64 space-y-4">
                ...
                {isTyping ? (
                  <div className="flex items-end gap-2">
                    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#3B6FF6] to-[#6E97FF] shrink-0 flex items-center justify-center">
                      <Zap className="w-3 h-3 text-white fill-white" />
                    </div>
                    <div className="bg-[#eef3ff] dark:bg-[#0e1730] rounded-2xl rounded-bl-sm px-4 py-3">
                      <div className="flex items-center gap-1">
                        {[0, 1, 2].map((i) => (
                          <span key={i} className="w-2 h-2 rounded-full bg-[#3B6FF6] typing-dot" />
                        ))}
                      </div>
                    </div>
                  </div>
                  ...
                  <AnimatePresence mode="wait">
                    {showAI && (
                      ...
                      >
                        <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#3B6FF6] to-[#6E97FF] shrink-0 flex items-center justify-center mt-0.5 shadow-sm">
                          <Zap className="w-3 h-3 text-white fill-white" />
                        </div>
                        <div className="bg-[#eef3ff] dark:bg-[#0e1730] rounded-2xl rounded-tl-sm px-4 py-2.5 max-w-xs border border-[#3B6FF6]/10">
              ...
              <div className="px-5 pb-5">
                <div className="flex items-center gap-3 bg-[#f7f6f3] dark:bg-[#201f1c] rounded-xl px-4 py-3 border border-[#e8e8e4] dark:border-[#2a2824]">
                  ...
                  <button className="w-8 h-8 rounded-lg bg-[#3B6FF6] hover:bg-[#2554D8] flex items-center justify-center transition-colors">
            ...
            {/* Ambient glow */}
            <div className="absolute -z-10 inset-0 bg-gradient-to-br from-[#3B6FF6]/10 to-[#6E97FF]/5 rounded-3xl blur-2xl scale-110" />
          </div>
        </div>
      </div>
    </section>
