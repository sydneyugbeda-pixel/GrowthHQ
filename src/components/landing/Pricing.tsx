            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isPro
                    ? "bg-gradient-to-b from-[#C4622D] to-[#A5511F] border-transparent text-white shadow-2xl shadow-orange-500/25 scale-[1.02]"
              ...
              >
                ...
                <div className="mb-5">
                  ...
                  <p className={cn("text-sm", isPro ? "text-orange-100" : "text-[#9ca3af]")}>{plan.description}</p>
                </div>

                <div className="mb-6">
                  <div className="flex items-end gap-1">
                    <span className={cn("text-4xl font-black", isPro ? "text-white" : "text-[#1a1a1a] dark:text-white")}>${price}</span>
                    {price > 0 && <span className={cn("text-sm mb-1.5 font-medium", isPro ? "text-orange-100" : "text-[#9ca3af]")}>/mo</span>}
                  </div>
                  {annual && price > 0 && (
                    <p className={cn("text-xs mt-1", isPro ? "text-orange-100" : "text-[#9ca3af]")}>Billed annually (${price * 12}/yr)</p>
                  )}
                </div>
                  ...
                  <Button
                    ...
                    className={cn("w-full justify-center font-bold",
                      isPro
                        ...
                        : "bg-[#fdf0e8] text-[#C4622D] hover:bg-[#fce8d5] border border-[#C4622D]/20"
                    )}
                ...
                <ul className="space-y-2.5">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-center gap-2.5 text-sm">
                      <Check className={cn("w-4 h-4 shrink-0", isPro ? "text-orange-100" : "text-[#C4622D]")} />
