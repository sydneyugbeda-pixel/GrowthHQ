      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            <div
              key={t.name}
              className="group bg-white dark:bg-[#1a1916] rounded-2xl p-6 border border-[#e8e8e4] dark:border-[#2a2824] hover:border-[#2563EB]/30 hover:shadow-xl hover:shadow-brand-500/5 transition-all duration-300 hover:-translate-y-1 flex flex-col"
            >
              {/* Stars */}
              ...
              {/* Highlight badge */}
              <div className="inline-flex self-start items-center px-2.5 py-1 rounded-full bg-[#EFF6FF] dark:bg-[#1E3A8A] text-[#2563EB] dark:text-[#3B82F6] text-xs font-bold mb-4 border border-[#2563EB]/15">
                {t.highlight}
              </div>
