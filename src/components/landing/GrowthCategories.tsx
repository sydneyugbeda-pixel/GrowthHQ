      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {GROWTH_CATEGORIES.map((cat, i) => (
            ...
            >
              <Link
                ...
                className="group flex flex-col items-center p-6 rounded-2xl bg-white dark:bg-[#1a1916] border border-[#e8e8e4] dark:border-[#2a2824] hover:border-[#2563EB]/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-brand-500/8 text-center"
              >
                ...
                <span className="text-xs text-[#9ca3af] group-hover:text-[#2563EB] transition-colors flex items-center gap-0.5 font-medium">
          ...
          >
            <Link
              href="/auth/signup"
              className="flex flex-col items-center justify-center p-6 rounded-2xl bg-gradient-to-br from-[#2563EB] to-[#3B82F6] text-white text-center hover:-translate-y-1 transition-transform shadow-lg shadow-brand-500/20"
            >
